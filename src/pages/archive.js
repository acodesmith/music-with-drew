    ...
    <table className="table-auto w-full" {...getTableProps()}>
            ...
            {headerGroup.headers.map(column => (
              ...
              <th
                className={`${theme(
                  "bg-blue-100",
                  "bg-blue-900"
                )} border-solid border-2 border-gray-300 border-t-0 border-l-0 border-r-0 sticky top-0 px-2 py-1 ${
      ...
      <tbody {...getTableBodyProps()}>
        {rows.map((row, i) => {
          ...
          return (
            <tr
              className={i % 2 === 0 ? theme("bg-gray-100", "bg-gray-800") : ""}
              {...row.getRowProps()}
            >
                ...
                return (
                  <td
                    className={`${theme(
                      "border-gray-200",
                      "border-gray-600"
                    )} border px-2 py-1 ${index === 0 ? "border-l-0" : ""} ${
        ...
        <div className="container flex flex-col mx-auto max-w-screen-md max-h-screen pt-4">
          ...
          <div
            className={`${theme("text-black", "text-gray-100")} ${theme(
              "bg-white",
              "bg-gray-700"
            )}  rounded-lg shadow-xl flex-auto overflow-scroll mb-3`}
          >
